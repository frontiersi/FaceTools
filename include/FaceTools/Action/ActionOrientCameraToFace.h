...
public:
     ...
     */
    ActionOrientCameraToFace( const QString&, const QIcon&, const QKeySequence& ks=QKeySequence(),
                              float p=1.0f,
                              int raxis=1,
                              float rads=0.0f);
    ...
    static void orientToFace( const Vis::FV*, float dprop=0, int raxis=1, float rads=0.0f);
