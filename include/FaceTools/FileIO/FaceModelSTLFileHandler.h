...
#ifndef FACE_TOOLS_FILE_IO_FACE_MODEL_STL_FILE_HANDLER_H
#define FACE_TOOLS_FILE_IO_FACE_MODEL_STL_FILE_HANDLER_H
...
class FaceTools_EXPORT FaceModelSTLFileHandler : public FaceModelFileHandler
{
public:
    FaceModelSTLFileHandler();
