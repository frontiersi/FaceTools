...
#ifndef FACE_TOOLS_VIS_ASYMMETRY_VISUALISER_H
#define FACE_TOOLS_VIS_ASYMMETRY_VISUALISER_H

#include "MetricVisualiser.h"
#include "AsymmetryView.h"

namespace FaceTools { namespace Vis {

class FaceTools_EXPORT AsymmetryVisualiser : public MetricVisualiser
{
public:
    const char* name() const override { return "AsymmetryVisualiser";}
...
private:
    std::unordered_map<const FV*, std::vector<AsymmetryView*> > _views;
};  // end class
