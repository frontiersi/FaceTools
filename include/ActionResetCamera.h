...
{ Q_OBJECT
public:
    explicit ActionResetCamera( const std::string& iconfilename="");

    virtual const QIcon* getIcon() const { return &_icon;}
    virtual QString getDisplayName() const { return "Reset Camera";}

    virtual void addInteractor( ModelInteractor*);  // Autofires on add
