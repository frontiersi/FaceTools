...
#ifndef FACE_TOOLS_POINTS_VISUALISATION_H
#define FACE_TOOLS_POINTS_VISUALISATION_H

#include "VisualisationAction.h"

namespace FaceTools {

class FaceTools_EXPORT PointsVisualisation : public VisualisationAction
{ Q_OBJECT
public:
    PointsVisualisation( const std::string& iconfile="", bool isDefaultVis=false);
    virtual ~PointsVisualisation(){}

    virtual const QIcon* getIcon() const { return &_icon;}
    virtual QString getDisplayName() const { return "Points";}
    ...
    virtual bool allowSetVertexSize() const { return true;}
