...
#ifndef FACE_TOOLS_FILE_IO_FACE_MODEL_PLY_FILE_HANDLER_H
#define FACE_TOOLS_FILE_IO_FACE_MODEL_PLY_FILE_HANDLER_H

#include <AssetImporter.h>  // RModelIO
#include <PLYExporter.h>    // RModelIO
...
private:
    ...
    RModelIO::PLYExporter _exporter;
