...
#ifndef FACE_TOOLS_SELECT_MOUSE_HANDLER_H
#define FACE_TOOLS_SELECT_MOUSE_HANDLER_H
...
class FaceTools_EXPORT SelectMouseHandler : public MouseHandler
{ Q_OBJECT
public:
    SelectMouseHandler(); // ModelViewerInteractor attaches to all ModelSelector::viewers().
