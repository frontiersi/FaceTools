...
#ifndef FACE_TOOLS_ACTION_TOGGLE_SHOW_BOUNDARY_H
#define FACE_TOOLS_ACTION_TOGGLE_SHOW_BOUNDARY_H
...
class FaceTools_EXPORT ActionToggleShowBoundary : public FaceAction
{ Q_OBJECT
public:
    explicit ActionToggleShowBoundary( const std::string& iconfilename);

    virtual const QIcon* getIcon() const { return &_icon;}
    virtual QString getDisplayName() const { return "Show Boundary";}
