...
#include <vtkMapper.h>
using FaceTools::WireframeVisualisation;

WireframeVisualisation::WireframeVisualisation( const std::string& iconfile, bool isdefault)
...
// public
vtkSmartPointer<vtkActor> WireframeVisualisation::makeActor( const FaceTools::FaceModel* fmodel)
{
