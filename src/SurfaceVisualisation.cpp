...
#include <vtkMapper.h>
using FaceTools::SurfaceVisualisation;

SurfaceVisualisation::SurfaceVisualisation( const std::string& iconfile, bool isdefault)
...
// public
vtkSmartPointer<vtkActor> SurfaceVisualisation::makeActor( const FaceTools::FaceModel* fmodel)
{
