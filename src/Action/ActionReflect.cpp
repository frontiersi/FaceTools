...
ActionReflect::ActionReflect( const QString &dn, const QIcon& ico, const QKeySequence &ks)
...
void ActionReflect::restoreState( const UndoState &us)
{
...
Event ActionReflect::doAfterAction( Event)
{
    QString smsg = "Reflected model through YZ plane.";
    if ( MS::selectedModel()->hasMask())
